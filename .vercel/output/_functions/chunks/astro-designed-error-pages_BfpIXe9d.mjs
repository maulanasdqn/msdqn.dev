import { N as NOOP_MIDDLEWARE_HEADER, R as REDIRECT_STATUS_CODES, A as AstroError, g as ActionsReturnedInvalidDataError, D as DEFAULT_404_COMPONENT } from './astro/server_Do_YPnBi.mjs';
...
function serializeActionResult(res) {
  if (res.error) {
    if (Object.assign(__vite_import_meta_env__, { PORT: process.env.PORT })?.DEV) {
